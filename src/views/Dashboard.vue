...
export default {
  ...
  data: () => ({
    team: [
      { name: "Iyad", role: "web developer", avatar: "../assets/selected.png" },
      { name: "Reda", role: "Graphic designer", avatar: "../assets/av-2.png" },
      { name: "Zineb", role: "web developer", avatar: "../assets/av-3.png" },
      { name: "Hu TechGroup", role: "Desktop developer", avatar: "../assets/av-4.png" },
    ],
  }),
};
</script>